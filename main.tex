...
\end{equation}
similarly, one obtains for the field $\psi_{B,ij}$,
\begin{equation}
...
\section*{Acknowledgements}
BG thanks the Zentrum f\"ur Astronomie, Heidelberg University for hosting her, the Swiss National Science Foundation for funding the project and Ruth Durrer for valuable feedback and comments.  BMS likes to thank the Universidad del Valle in Cali, Colombia, for their kind hospitality. We thank Jolanta Zjupa for spotting a mistake in an early version of the draft.
