...
\centering
%\includegraphics[scale=0.1]{wip.jpg}
\caption{Maringalised $1\sigma$-errors from the Fisher-matrix analysis on a standard $\Lambda$CDM-parameter set, separated by lensing, intrinsic alignments, and both combined, with a variable value of the alignment parameter $D$.}
\label{fig:fisher2}
\end{figure}
